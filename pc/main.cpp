...
template <class resulst_t, class lhs_t, class rhs_t>
struct add
{
...
using address_t = strong_type<uint32_t, ops::plus<int, ops::self_t>,
    ops::unary_plus<int, ops::self_t>, ops::plus<offset_t, ops::self_t, ops::self_t, true>,
    ops::unary_plus<offset_t, ops::self_t>, ops::minus<ops::self_t, offset_t>, ops::minus<>>;
