...
struct data_reg_t : ucpp::registers::reg_t<uint8_t, regs::address>
{
    using ucpp::registers::reg_t<uint8_t, regs::address>::operator=;
    using ucpp::registers::reg_t<uint8_t, regs::address>::operator|=;
    using ucpp::registers::reg_t<uint8_t, regs::address>::operator&=;
};

template <typename regs>
struct data_reg_t<regs, w16bits> : ucpp::registers::reg_t<uint16_t, regs::address>
{
    using ucpp::registers::reg_t<uint16_t, regs::address>::operator=;
    using ucpp::registers::reg_t<uint16_t, regs::address>::operator|=;
    using ucpp::registers::reg_t<uint16_t, regs::address>::operator&=;
};

template <typename regs>
struct data_reg_t<regs, w32bits> : ucpp::registers::reg_t<uint32_t, regs::address>
{
    using ucpp::registers::reg_t<uint32_t, regs::address>::operator=;
    using ucpp::registers::reg_t<uint32_t, regs::address>::operator|=;
    using ucpp::registers::reg_t<uint32_t, regs::address>::operator&=;
};
...
struct SPI
{
    ...
    {
        static_assert(ucpp::utils::is_one_of<T, char, uint8_t, uint16_t, uint32_t>::value,
